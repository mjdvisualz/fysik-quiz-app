...
Inden vi gang i gang med koden og "UI", så skitserede vi, hvordan vores UI skulle være.
I koden begyndte vi først at designe vores UI, hvor vi designede og tilføjede vores "Tkinter labels" og "Tkinter buttons".Vi tilføjede...
## 5. Et skema med test.
